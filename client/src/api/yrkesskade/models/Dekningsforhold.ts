...
export type Dekningsforhold = {
    ...
    tjenesteperiodeEllerManoever?: Periode;
    underOrdreOmManoever?: boolean;
    navnPaatjenestegjoerendeavdelingEllerFartoeyEllerStudiested?: string;
    utdanningStart?: string;
};
